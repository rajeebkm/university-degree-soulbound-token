...
contract LinkDOTSBT is ERC721URIStorage  {
    ...
    constructor() ERC721("LinkDOTSBT", "LDOTSBT") {
        owner = msg.sender;
    }
    ...
    function claimDegree(string memory tokenURI)
        ...
        returns (uint256)
    {
        require(issuedDegrees[msg.sender], "Degree is not issued or already claimed");
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, "Only owner can issue SBTs");
        _;
    }
    ...
    function issueDegree(address to) onlyOwner external {
        require(issuedDegrees[to] == false, "Already degree issued");
